...
int main()
{
   ...
   do
   {
      ...
      {
      case 1:
         printf("\nEscolha uma posicao para inserir: ");
         scanf("%d", &posicao);
      ...
      case 2:
         printf("\nEscolha uma posicao para remover: ");
         scanf("%d", &posicao);
         lista_remover_posicao(&lista, posicao);
         break;

      case 3:
         printf("\nEscolha uma posicao para visualizar: ");
         scanf("%d", &posicao);
      ...
      case 4:
         ...
         scanf("%d", &valor);
         printf("Elemento encontrado na posicao %d.", lista_busca_valor(&lista, valor));
         break;
